error id: file:///D:/dev/workspaces/eclipse-workspace-2022/PDS-Spark/Scala/src/main/scala/Walmart.scala:org/apache/spark/sql/Dataset#show(+1).
...
Product_ID|  Age|City_Category|Max Prodaja|
 ...
 P00058042|26-35|            B|        225|
    ...
    */
    ...
    val topOccupationKupovina = occupationProizvodDS.withColumn("Max Kupovina", max("Amount")
