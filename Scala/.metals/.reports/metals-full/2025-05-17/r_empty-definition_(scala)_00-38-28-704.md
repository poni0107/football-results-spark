error id: file:///D:/dev/workspaces/eclipse-workspace-2022/PDS-Spark/Scala/src/main/scala/Walmart.scala:
...
100000@@1| P00085442|     F| 0-17|        10|            A|                         2|             0|              12|    1057|
...
1004474|         7|            C|16639.941176470587|
    ...
    */
    ...
    //val product_window = Window.partitionBy("Product_ID")
    ...
    //val topProizvodProdaja = proizvodProdajaMaxSale.filter($"Prodaja" === $"Max Prodaja").drop("Prodaja") 
 
    // val zad2Res = topProizvodProdaja.orderBy($"Max Prodaja".desc)
...
Product_ID|  Age|City_Category|Max Prodaja|
 ...
 P00058042|26-35|            B|        225|
    ...
    */
    ...
    val occupationWindow = Window.partitionBy("Occupation", "Gender")

    val occupKupovina = occupationProizvodDS.withColumn("Max Kupovina", max("Amount")
                                            .over(occupationWindow))
...
Occupation|Gender|Product_Category|Max Category Kupovina|Product_ID|Max Kupovina|
    ...
    */
    ...
    // ZADATAK 4. - 4.	Да  ли у некој животној доби, самци мушкарци више троше него жене у некој категорији града? 
    // Дати пример таквих категорија градова и животног доба. Ако не постоји ниједна таква кобинација животне доби и категорије града, 
    // онда навести животне доби где је та разлика најмања у корист жена.
