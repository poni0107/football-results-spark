error id: file:///D:/dev/workspaces/eclipse-workspace-2022/PDS-Spark/Scala/src/main/scala/Walmart.scala:_empty_/Walmart.wallmartDS.
file:///D:/dev/workspaces/eclipse-workspace-2022/PDS-Spark/Scala/src/main/scala/Walmart.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol _empty_/Walmart.wallmartDS.
...
Product_ID|  Age|City_Category|Max Prodaja|
 ...
 P00058042|26-35|            B|        225|
    ...
    */
    ...
    val occupationProizvodDS = wallmartDS.groupBy("Occupation", "Product_ID", "Gender")
                                    .agg(count("*") as "Amount")
